...
variable "router_inside_private_ip" {
  type        = string
  description = "Static private IP address of the inside NIC on the hub router VM."
  default     = "10.0.1.4"
}

variable "router_outside_private_ip" {
  type        = string
  description = "Static private IP address of the outside NIC on the hub router VM."
  default     = "10.0.2.4"
}
