...
The SSH key pair is generated locally by `tls.tf`, following the same pattern used in `/Users/mlinxfeld/codes/github/terraform-az-fk-compute/examples/01_single_vm/tls.tf`.
