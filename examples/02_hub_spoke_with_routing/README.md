...
The SSH key pair is generated locally by `tls.tf`, following the same pattern used in [terraform-az-fk-compute](https://github.com/foggykitchen/terraform-az-fk-compute/blob/main/examples/01_single_vm/tls.tf).
